...
<html>
  ...
  window.onload=function(){
	  document.getElementById("nav-menu").getElementsByTagName("li")[6].setAttribute("class","navLi actived");
  }
</script>
	<style type="text/css">
		/* div{
  ...
  <jsp:include page="./top.jsp"></jsp:include><!-- 引入头部 -->
   	...
   	<div class="container">
   		<div class="row">
   			...
   			<div class="col-sm-6 col-sm-offset-6 text-center h3">分数:(仅提供客观题参考分数)</div>
