 ...
 <!-- 导航条 -->
	<div class="top-nav">	
		<ul class="nav-menu" id="nav-menu">
			...
			<li class="navLi"><a href="#" class="ttt">考研数学</a></li>
			<li class="navLi" id="submenu"><a href="#" class="ttt">自主学习</a>
				<ul class="submenu">
					<li class="submenuLi"><a href="${pageContext.request.contextPath }/KnowPointController/toKnowPointView.action?id=1" class="ttt">知识点</a></li>
					<li class="submenuLi"><a href="${pageContext.request.contextPath }/BrushTitleController/toBrushTitle.action?id=1" class="ttt">在线刷题</a></li>
				</ul>
			</li>
			<li class="navLi">
